...
namespace Com.Drew.Metadata.Exif
{
	...
	public class ExifThumbnailDescriptor : TagDescriptor<ExifThumbnailDirectory>
	{
		...
		{
			return GetIndexedDescription(ExifThumbnailDirectory.TagOrientation, 1, "Top, left side (Horizontal / normal)", "Top, right side (Mirror horizontal)", "Bottom, right side (Rotate 180)", "Bottom, left side (Mirror vertical)", "Left side, top (Mirror horizontal and rotate 270 CW)"
