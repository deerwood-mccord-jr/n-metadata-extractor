...
namespace Com.Drew.Metadata.Exif
{
	...
	public class ExifSubIFDDescriptor : TagDescriptor<ExifSubIFDDirectory>
	{
		...
		{
			return GetIndexedDescription(ExifSubIFDDirectory.TagNewSubfileType, 1, "Full-resolution image", "Reduced-resolution image", "Single page of multi-page reduced-resolution image", "Transparency mask", "Transparency mask of reduced-resolution image"
		...
		{
			return GetIndexedDescription(ExifSubIFDDirectory.TagExposureProgram, 1, "Manual control", "Program normal", "Aperture priority", "Shutter priority", "Program creative (slow program)", "Program action (high-speed program)", "Portrait mode", "Landscape mode"
				);
		}
